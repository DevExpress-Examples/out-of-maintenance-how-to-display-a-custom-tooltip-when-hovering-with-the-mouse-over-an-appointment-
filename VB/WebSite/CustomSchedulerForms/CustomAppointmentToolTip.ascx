...
<script type="text/javascript" id="dxss_">
	ASPxClientAppointmentToolTip = _aspxCreateClass(ASPxClientToolTipBase, {
		...
		Update: function(data) {
			...
			/*if (!apt.updated) {
				this.scheduler.RefreshClientAppointmentProperties(apt, AppointmentPropertyNames.Normal + ";PriceCustomField", _aspxCreateDelegate(this.OnAppointmentRefresh, this));
